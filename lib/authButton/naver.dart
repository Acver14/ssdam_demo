...
/// A sign in button that matches Naver's design guidelines.
///
...
class NaverSignInButton extends StatelessWidget {
  ...
  NaverSignInButton(
      {this.onPressed,
        this.text = 'Naver로 시작하기',
        this.textStyle,
        this.splashColor,
        this.darkMode = false,
        // Naver doesn't specify a border radius, but this looks about right.
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child:RaisedButton(
        ...
        child: Row(
          children: <Widget>[
            // The Naver design guidelines aren't consistent. The dark mode
