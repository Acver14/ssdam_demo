  ...
  Widget build(BuildContext context) {
    ...
    return IamportPayment(
      ...
      data: PaymentData.fromJson({
        'pg': 'html5_inicis.MOIcmak139', // PG사
        'payMethod': 'card', // 결제수단
        'name': '쓰담 이용권 구매', // 주문명
        'merchantUid':
      ...
      callback: (Map<String, String> result) async {
        ...
        } else if (result['imp_success'] == 'false') {
          await PopupBox.showPopupBox(
              context: context,
              button: MaterialButton(
                onPressed: () {},
...
class Payment_promotion5000 extends StatelessWidget {
  FirebaseProvider fp;
  ...
  Widget build(BuildContext context) {
    ...
    return IamportPayment(
      ...
      data: PaymentData.fromJson({
        ...
        'name': '쓰담 이용권 구매', // 주문명
        'merchantUid':
        '${fp.getUserInfo()['email']}_promotion5000_${DateTime
            .now()
