                      ...
                      children: <Widget>[
                        ...
                        !otp_true ? Row(
                          children: [
                            ...
                            FlatButton(
                                child: Text(
                                  '전송', style: TextStyle(fontSize: 18),),
                                onPressed: () async {
                                  ...
                                  if (phone_check) {
                                    showGuidance('중복된 번호입니다.', _scaffoldKey);
                                  }
                                  else {
                                    await _otp.sendOtp(
                                        _phoneCon.text.trim(), null, 1000, 9999,
                                        '+82');
                                    setState(() {
                                      otp_send = true;
                                    });
                        ...
                        Row(
                          children: [
                            ...
                            FlatButton(
                                child: Text(
                                  '확인', style: TextStyle(fontSize: 18),),
                                onPressed: () async {
                                  ...
                                  if (result) {
                                    ...
                                    showGuidance(
                                        '잘못된 인증 번호입니다. 재전송합니다.', _scaffoldKey);
                                    await _otp.sendOtp(
                                        _phoneCon.text.trim(), null, 0000, 9999,
                                        '+82');
                                  }
                                }
                            )
                          ...
                          children: [
                            ...
                            FlatButton(
                                ...
                                onPressed: () async {
                                  ...
                                  user_list.documents.forEach((element) {
                                    logger.d(element.data['promotionCode']);
                                  ...
                                  if (code_check) {
                                    ...
                                    showGuidance(
                                        '존재하지 않는 추천인 코드입니다.', _scaffoldKey);
                                  }
                                }
                            )
                          ],
                  ...
                  Row(
                    children: [
                      ...
                      FlatButton(child: Text(
                        '읽어보기', style: TextStyle(color: Colors.red),),
                        onPressed: () =>
                            launchWebView(
            ...
            Container(
              ...
              child: RaisedButton(
                ...
                onPressed: () async {
                  ...
                  logger.d(_nameCon.text.trim());
                  if (_nameCon.text.trim() == '' ||
                      _phoneCon.text.trim() == '' || _pwCon.text.trim() == '' ||
                      _mailCon.text.trim() == '') {
